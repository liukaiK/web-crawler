 ...
 */
public class Advice {
	private String cptTarget;
	private String cptTargetName;
	...
	public String getCptTarget() {
		return cptTarget;
	}
	public void setCptTarget(String cptTarget) {
		this.cptTarget = cptTarget;
	}
	public String getCptTargetName() {
		return cptTargetName;
	}
	public void setCptTargetName(String cptTargetName) {
		this.cptTargetName = cptTargetName;
	}
